    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredEvents.map((event) => (
          <div
            key={event.id}
            className="bg-white/80 backdrop-blur-lg rounded-3xl p-6 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm">
                  {event.date} {event.month} {event.year} • {event.time}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm">
                  {event.ticketTypes?.reduce(
                    (total, ticket) => total + (1000 - ticket.remaining),
                    0
                  ) || 0}{" "}
                  sold
                </span>
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm font-semibold text-green-600">
                  ...
                  {(
                    event.ticketTypes?.reduce(
                      (total, ticket) =>
                        total + (1000 - ticket.remaining) * ticket.price,
                      0
                    ) || 0
                  ).toLocaleString()}
                </span>
