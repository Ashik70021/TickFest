const Banner = () => {
    return (
        <div className="relative w-full h-screen mb-24">
            ...
            {/* Foreground Content */}
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-full mx-auto px-6 h-full">
                {/* Left Image */}
                ...
                <div className="w-full md:w-1/2 text-white space-y-6 text-center md:text-left">
                    ...
                    <p className="text-lg">
                        Look no further! Our SBS The Show tickets are the <br /> simplest way for you to experience a live Kpop <br /> recording.
                    </p>
