...
const Attendees = () => {
    ...
    // Mock attendees data
    const mockAttendees = [
        { id: 1, name: 'Ahmed Rahman', email: 'ahmed@email.com', phone: '+880 1234567890', ticketType: 'VIP', purchaseDate: '2024-12-01', eventId: 'concert-1', status: 'confirmed' },
        { id: 2, name: 'Fatima Khan', email: 'fatima@email.com', phone: '+880 1987654321', ticketType: 'General Admission', purchaseDate: '2024-12-02', eventId: 'concert-1', status: 'confirmed' },
        { id: 3, name: 'Mohammad Ali', email: 'ali@email.com', phone: '+880 1122334455', ticketType: 'Premium', purchaseDate: '2024-11-15', eventId: 'concert-2', status: 'confirmed' },
        { id: 4, name: 'Rashida Begum', email: 'rashida@email.com', phone: '+880 1555666777', ticketType: 'General Admission', purchaseDate: '2024-11-16', eventId: 'concert-2', status: 'pending' },
        { id: 5, name: 'Karim Hassan', email: 'karim@email.com', phone: '+880 1333444555', ticketType: 'VIP', purchaseDate: '2024-12-10', eventId: 'sports-1', status: 'confirmed' },
        { id: 6, name: 'Nasir Ahmed', email: 'nasir@email.com', phone: '+880 1777888999', ticketType: 'General Admission', purchaseDate: '2024-12-11', eventId: 'sports-1', status: 'confirmed' },
        { id: 7, name: 'Salma Khatun', email: 'salma@email.com', phone: '+880 1666777888', ticketType: 'Premium', purchaseDate: '2024-12-05', eventId: 'concert-1', status: 'confirmed' },
        { id: 8, name: 'Habib Rahman', email: 'habib@email.com', phone: '+880 1444555666', ticketType: 'General Admission', purchaseDate: '2024-11-20', eventId: 'concert-2', status: 'cancelled' },
    ];
    ...
    const handleExportData = () => {
        // Simple CSV export
        const csvContent = [
            ['Name', 'Email', 'Phone', 'Event', 'Ticket Type', 'Purchase Date', 'Status'],
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-xs text-green-600 font-semibold bg-green-100 px-2 py-1 rounded-full">Confirmed</span>
                    </div>
                ...
                <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-xs text-yellow-600 font-semibold bg-yellow-100 px-2 py-1 rounded-full">Pending</span>
                    </div>
                ...
                <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-xs text-red-600 font-semibold bg-red-100 px-2 py-1 rounded-full">Cancelled</span>
                    </div>
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex-1">
                        <label className="block text-sm font-semibold text-gray-700 mb-2">Search Attendees</label>
                        <input
                            type="text"
                            value={searchTerm}
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-6 shadow-xl border border-white/20">
                ...
                {filteredAttendees.length > 0 ? (
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-200">
                                    ...
                                    <th className="text-left py-3 px-4 font-semibold text-gray-700">Ticket Type</th>
                            ...
                            <tbody>
                                {filteredAttendees.map((attendee) => (
                                    <tr key={attendee.id} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="py-4 px-4">
                                            <p className="text-sm text-gray-600">{attendee.purchaseDate}</p>
                                        </td>
                                        <td className="py-4 px-4">
                    ...
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-bold text-gray-600 mb-2">No attendees found</h3>
                        <p className="text-gray-500">
                            {searchTerm ? "No attendees match your search criteria." : "No attendees found for the selected filters."}
                        </p>
                    </div>
                )}
            </div>
